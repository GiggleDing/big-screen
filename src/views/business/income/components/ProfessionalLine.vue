<template>
    <el-row style="width: 100%; height: 50%;">
        <el-col class="content" :span="4">公众渠道</el-col>
    ...
    <el-row style="width: 100%; height: 50%;">
        <el-col class="content" :span="4">政企渠道</el-col>
        <el-col class="content" :span="20" style="height: 100%;">
...
import { getRevenue } from '../../../../api/business'
...
const fetchData = async() => {
    try {
        ...
        const [res1, res2] = await Promise.all([
            getRevenue(dateParam, 'root', { profession: 'public' }),
            getRevenue(dateParam, 'root', { profession: 'enterprise'})
        ])
